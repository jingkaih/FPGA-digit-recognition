...
result_predict = model.predict(X_test[2:11], batch_size = 1)
print(result_predict)

datafile = 'mnist_nn_quantized_zeroone_FC.h5' # Change this if you want to rename your weights file. 
                                              # Note that it will generate a file into the user's personal folder in Windows
